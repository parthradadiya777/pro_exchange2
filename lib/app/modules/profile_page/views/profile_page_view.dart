                      ...
                      child: StreamBuilder(
                        ...
                        return ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                    ...
                                    Container(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Expanded(
                                                            child: Container(
                                                              child: Image.network(snapshot.data!.docs[i]['imgurl'][0]),
                                                            )),
                                                      ],
                                                    ),
                                                  )),
                                        ...
                                        selected
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  IconButton(onPressed: (){
                                                    ...
                                                    Navigator.of(context).pushNamed(Routes.EDIT_PROFILE,arguments: {
                                                      'category':category,
                                                      'sell':sell,
                                                      'uid1':id,
                                                    }
                                          ...
                                          //  await pdf();
                                              ...
                                              b?Text(file!=null ? Path.basename(file!.path) : 'No File'):Text('Add Another'),
                                  ...
                                  b?task !=null ? builduplodstatus(task!) : Container(child: Text('hhh'),):Text(''),
                                             // Text(filename)
                                            ],
                                          ),
                                        )
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Container(child: InkWell(child: Text('save'),onTap: ()async{
                                                    await uploadFile();
                                                    var id=snapshot.data!.docs[i].id;
                                                    FirebaseFirestore.instance.collection('products').doc(id).update({
                                                      'imgurl':FieldValue.arrayUnion(a)
                                                                          ...
                                                                          child: Row(
                                                                            ...
                                                                            IconButton(
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  var val = [];
                                                                                  var id=snapshot.data!.docs[i].id;
                                                                                  var image=snapshot.data!.docs[i]['imgurl'][index];
                                                                                  val.add(image);
                                                                                  print(val);
                                                                                  print(image);
