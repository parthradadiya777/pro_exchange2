...
class MobileCategoryView extends GetView<MobileController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:StreamBuilder(
          stream: FirebaseFirestore.instance.collection('products').where('category',isEqualTo: "Mobile").snapshots(),
