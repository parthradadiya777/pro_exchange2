...
class OthersCategoryView extends GetView<OthersController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:StreamBuilder(
          stream: FirebaseFirestore.instance.collection('products').where('category',isEqualTo: "Others").snapshots(),
