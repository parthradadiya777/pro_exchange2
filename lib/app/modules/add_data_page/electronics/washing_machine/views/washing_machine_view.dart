...
class Washing_MachineView extends StatefulWidget {
  ...
  @override
  State<Washing_MachineView> createState() => _Washing_MachineViewState();
}

class _Washing_MachineViewState extends State<Washing_MachineView> {
          ...
          child: Column(
            children: [
              ...
              MaterialButton(
                onPressed: () async {
                  await uploadFile();
                  WashingStoreData().WashingStoreData1(Adtitle.text, description.text, a, biding, price.text, _auth.currentUser!.uid, 'Washing Machine',Address,latitude,'W');
