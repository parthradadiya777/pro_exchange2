...
class PrinterMoniterView extends StatefulWidget {
  const PrinterMoniterView({Key? key}) : super(key: key);

  @override
  State<PrinterMoniterView> createState() => _PrinterMoniterViewState();
}

class _PrinterMoniterViewState extends State<PrinterMoniterView> {
        ...
        child: Column(
          children: [
            ...
            MaterialButton(
              onPressed: () async {
                await uploadFile();
                printerStoreData().printerStoreData1(Adtitle.text, description.text, a, biding, price.text, _auth.currentUser!.uid, 'Printer',Address,latitude,'P');
              //  BikesStoreData().BikesData1(Bikebrand, year.text, km.text, Adtitle.text, description.text, a, biding,price.text, _auth.currentUser!.uid, 'Bikes');
                cleartext();
              },
              child: Card(
                child: Container(
