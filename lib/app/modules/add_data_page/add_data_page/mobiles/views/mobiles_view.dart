...
import 'package:pro_exchange2/app/data/mobileData.dart';
...
//
  String mobilebrand = "abc";
  List mobilebrands = ['abc', 'def', 'ghi'];

  void mobileSelected(String value){
    setState(() {
      mobilebrand = value;
          ...
          child: Column(
            children: [
              ...
              MaterialButton(
                onPressed: () async {
                  await uploadFile();
                MobileStoreData().MobileData1(mobilebrand, Adtitle.text, description.text, a, biding,price.text, _auth.currentUser!.uid, 'Mobile',Address,latitude,'M') .whenComplete(() {
                  setState(() {
                    flag = false;
                    setState(() {
                      cleartext();
