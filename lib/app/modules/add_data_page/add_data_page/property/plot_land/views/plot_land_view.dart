...
class PlotLandView extends StatefulWidget {
  ...
  @override
  State<PlotLandView> createState() => _PlotLandViewState();
}

class _PlotLandViewState extends State<PlotLandView> {
  ...
  List rents = ['rent', 'forSale'];

  void rentselected(String value) {
    setState(() {
      rent = value;
    });
  }
