...
class ComutersLeptopView extends StatefulWidget {
  ...
  @override
  State<ComutersLeptopView> createState() => _ComutersLeptopViewState();
}

class _ComutersLeptopViewState extends State<ComutersLeptopView> {
          ...
          child: Column(
            children: [
              ...
              MaterialButton(
                onPressed: () async {
                  await uploadFile();
                  Computer_leptopStorageData().Computer_leptopStorageData1(
                      Adtitle.text,
                      description.text,
                      a,
                      biding,
